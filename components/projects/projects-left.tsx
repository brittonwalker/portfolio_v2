...
export function ProjectsLeft() {
  return (
    <div className="projects-left px-8 pt-[15vh] relative bg-background border-t border-foreground">
      <div
        className="projects-content flex flex-col gap-[10vw]"
        style={{
          padding: '0 6.25vw',
        }}
      >
...
const ProjectCard = ({
  ...
  return (
    <Link href={`/projects/${project.slug}`}>
      <div
        ref={cardRef}
        className="project-card grid grid-cols-5 gap-[3vw] overflow-hidden"
      >
        <div className="project-card__caption col-span-2">
          <div className="project-card__index leading-[1em] mb-4">
            {String(index + 1).padStart(2, '0')}
          </div>
          <h3 className="text-sub-title leading-[1.1em] md:leading-[3vw] text-balance">
            {project.title}
          </h3>
          <p className="project-card__description mt-4">
            {project.description}
          </p>
        </div>
