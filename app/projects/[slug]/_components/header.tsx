      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-7 grid grid-cols-2 gap-4">
          <div className="col-span-2 mb-10">
            ...
            Brooklyn, NY. Spoiler alert, it&apos;s where I&apos;ve forged my
            career. In 2024, I collaborated with the whole team to refresh their
            website using a custom headless WordPress built with Next.js,
            Three.js, and GraphQL. The site features a sleek, modern design that
            showcases their impressive portfolio of work and technology chops.
          </div>
